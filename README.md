...
`\data` includes SCE splits constructed for `llama3.1-8b-instruct` and `Qwen2.5-8b-instruct`. For each subset (CE / IE), the sample count is **matched** for fair comparison.
